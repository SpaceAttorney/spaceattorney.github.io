...
_Spirit Hunter: Death Mark_ is a VN about an amnesiac tasked with investigating and pacifying spirits a the behest of a creepy doll (pictured) in order to relieve himself of the titular curse. The gameplay mostly revolves around exploring the areas the spirits hang out in, collecting objects and information that are then used to survive encounters with said spirits. While it doesn't feel like a "detective game" _per se_, the player is expected to deduce each spirit's nature and past from scattered clues in order to either find an exploitable weakness and destroy it or resolve the regrets that are keeping it from passing on.
